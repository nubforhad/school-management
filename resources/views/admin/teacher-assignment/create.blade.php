...
@section('page-title', 'Assign Teacher')
...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
    ...
    <form action="{{ route('admin.teacher-assignment.store') }}"
          method="POST">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">
                        Select teacher, academic session, class, section and subject
                    </p>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-blue-700">
                                    A teacher can be assigned to a specific subject,
                                    class and section for an academic session.
                                </p>
