    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                Update student admission and personal information.
            </p>
        </div>
            ...
            <div class="grid grid-cols-1 gap-5 p-5 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div>
                    ...
                    <input
                        type="date"
                        name="admission_date"
                        value="{{ old('admission_date', $student->admission_date ? \Illuminate\Support\Carbon::parse($student->admission_date)->format('Y-m-d') : '') }}"
                        class="w-full rounded-xl border border-slate-300
                               px-4 py-2.5 text-sm text-slate-800
                               outline-none transition
                               focus:border-blue-500
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach(['A+','A-','B+','B-','AB+','AB-','O+','O-'] as $blood)
                            ...
                            <option
                                value="{{ $blood }}"
                                @selected(old('blood_group', $student->blood_group) === $blood)
                            >
                                {{ $blood }}
                            </option>
            ...
            <div class="flex items-center justify-between gap-4 p-5">
                ...
                <label class="relative inline-flex cursor-pointer items-center">
                    ...
                    <input
                        ...
                        value="1"
                        class="peer sr-only"
                        @checked(old('status', $student->status))
                    >
