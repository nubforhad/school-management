...
@section('title', 'Add Teacher / Staff')
@section('page-title', 'Add Teacher / Staff')
                        ...
                        <select name="designation_id"
                            ...
                            @foreach($designations as $designation)
                                ...
                                <option value="{{ $designation->id }}"
                                    {{ old('designation_id') == $designation->id
                                        ? 'selected'
                                        : '' }}>
                    ...
                    <div>
                        ...
                        <select name="employment_type"
                            ...
                            <option value="Permanent"
                                {{ old('employment_type', 'Permanent')
                                    == 'Permanent' ? 'selected' : '' }}>
                                Permanent
                            </option>

                            <option value="Temporary"
                                {{ old('employment_type') == 'Temporary'
                                    ? 'selected' : '' }}>
                                Temporary
                            </option>

                            <option value="Contractual"
                                {{ old('employment_type') == 'Contractual'
                                    ? 'selected' : '' }}>
                                Contractual
                            </option>
