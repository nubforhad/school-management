...
<div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-slate-500">
            Update teacher or staff attendance record.
        </p>
    </div>
...
<div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
    ...
    {{-- Form --}}
    <form method="POST"
          action="{{ route('admin.teacher-staff-attendance.update', $attendance) }}"
          class="p-5">
                ...
                <div>
                    ...
                    <select
                        ...
                        @foreach($teacherStaff ?? [] as $staff)
                            ...
                            <option
                                value="{{ $staff->id }}"
                                {{ old('teacher_staff_id', $attendance->teacher_staff_id) == $staff->id ? 'selected' : '' }}>
        ...
        <div class="mb-6">
            ...
            <div class="mb-4 flex items-center gap-2">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500">
                        Time is available for Present and Late attendance.
                    </p>
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        id="in_time"
                        name="in_time"
                        value="{{ old('in_time', $attendance->in_time ? \Carbon\Carbon::parse($attendance->in_time)->format('H:i') : '') }}"
                ...
                <div>
                    ...
                    <input
                        ...
                        id="out_time"
                        name="out_time"
                        value="{{ old('out_time', $attendance->out_time ? \Carbon\Carbon::parse($attendance->out_time)->format('H:i') : '') }}"
                        class="attendance-time w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-700 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400">
        ...
        <div class="mb-6">
            ...
            <div>
                ...
                <textarea
                    ...
                    class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100">{{ old('remarks', $attendance->remarks) }}</textarea>
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="text-sm text-blue-800">
                    ...
                    <p class="mt-0.5 text-xs text-blue-700">
                        In Time and Out Time are enabled only for
